#!/usr/bin/env python3
# build_report.py — Markdown 레포트·산출물을 HTML로 변환한다. (HTML이 기본 산출물)
#
# 사용법:
#   python tools/build_report.py workspace/reports/2609201200_stage2_order_backend.md
#   python tools/build_report.py workspace/reports/2609201200_stage2_order_backend.md --pdf   # (선택) PDF도 시도
#
...
# 심각도별 색상 — templates/refactor-request.yaml 및 외부 도구 등급과 일치시킨다
SEVERITY_COLORS = {
    # RR / reviewer 등급
    "blocker": "#7f0000",
    "high": "#e65100",
    "medium": "#f9a825",
    "low": "#2e7d32",
    # 외부 도구(code-security-auditor, qa-automation) 등급
    "Blocker": "#7f0000",
    "Critical": "#b00020",
    "High": "#e65100",
    "Major": "#e65100",
...
{content}
<div class="footer">생성: {generated} (KST) · project-agents</div>
<script>
