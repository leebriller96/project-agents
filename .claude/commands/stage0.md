---
description: 0단계 준비 — workspace/00_inputs/ 의 문서·AS-IS 소스를 읽어 PROJECT_BRIEF.md 등 요약 지식을 만듭니다.
argument-hint: "(인자 없음)"
---
...
## 절차
1. `.claude/skills/pipeline-core/SKILL.md` §1 시작 절차를 수행한다 (config·state 확인, 선행 조건: `workspace/00_inputs/` 에 파일 1개 이상).
