...
3. `workspace/knowledge/PROJECT_BRIEF.md`, (있으면) `ASIS_INVENTORY.md`, 기존 `workspace/slices/slices.yaml`
...
- `approved` 는 항상 `false` 로 둔다. `workspace/state.yaml` 은 직접 수정하지 않는다.
